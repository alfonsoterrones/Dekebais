			...
			public void mousePressed(MouseEvent e) {
				//Cargarrrrr
				 try {
					 ...
					 while (rset.next()){
							if( (rset.getString ("NOMBREEMPLE")+" "+rset.getString ("APELLIDOPRIMERO")+" "+rset.getString ("APELLIDOSEGUNDO")).equals(componente)){
								String Consulta="delete from COMPONENTE where NOMBREEMPLE='"+rset.getString ("NOMBREEMPLE")+"' and APELLIDOPRIMERO='"+rset.getString ("APELLIDOPRIMERO")+"'";
			...
			gl_contentPane.createParallelGroup(Alignment.LEADING)
				.addGroup(Alignment.TRAILING, gl_contentPane.createSequentialGroup()
					...
					.addGroup(gl_contentPane.createParallelGroup(Alignment.TRAILING, false)
						...
						.addComponent(lblseguroQueDeseas))
					.addGap(73))
		);
