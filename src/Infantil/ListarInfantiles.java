	...
	public ListarInfantiles() {
		...
		try {
			...
			ResultSet rset = stm.executeQuery(
					"select NOMBREEMPLE,COMPONENTE,APELLIDOPRIMERO,FECHNACIMIENTO from COMPONENTE order by NOMBREEMPLE");
			...
			groupLayout.setHorizontalGroup(groupLayout.createParallelGroup(Alignment.LEADING)
					.addGroup(groupLayout.createSequentialGroup().addContainerGap().addComponent(lblElDeLa)
							.addPreferredGap(ComponentPlacement.RELATED, 132, Short.MAX_VALUE).addComponent(btnImprimir)
							.addGap(21))
					.addGroup(groupLayout.createSequentialGroup().addGroup(groupLayout
							.createParallelGroup(Alignment.LEADING)
							.addGroup(groupLayout.createSequentialGroup().addGap(21).addComponent(cursos,
			...
			groupLayout.setVerticalGroup(groupLayout.createParallelGroup(Alignment.LEADING).addGroup(Alignment.TRAILING,
					groupLayout.createSequentialGroup().addGroup(groupLayout.createParallelGroup(Alignment.TRAILING)
							...
							.addPreferredGap(ComponentPlacement.RELATED).addComponent(lblTotalInfantiles)
							.addContainerGap()));
