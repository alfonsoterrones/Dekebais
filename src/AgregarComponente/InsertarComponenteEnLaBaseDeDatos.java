...
public class InsertarComponenteEnLaBaseDeDatos {
	...
	public InsertarComponenteEnLaBaseDeDatos(String nombre, String apellido1, String apellido2, String mail,
			String fecha, String saldo, String amigo, String telefono, String cuerpo, String nuevo, String sexo,
			String modista, String apuntado) {
		...
		try {
			...
			// insert the data
			String Consulta = "INSERT INTO Componente " + "VALUES ('" + nombre + "', '" + apellido1 + "', '" + apellido2
					+ "', '" + mail + "','" + fecha + "'," + saldo + ",'" + amigo + "','" + telefono + "','" + cuerpo
					+ "','" + sexo + "','" + anoDeComponente + "','" + modista + "','" + apuntado + "','" + nuevo
					+ "')";
