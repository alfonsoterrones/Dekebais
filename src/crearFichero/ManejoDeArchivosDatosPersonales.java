...
public class ManejoDeArchivosDatosPersonales extends JFrame{
	...
	public ManejoDeArchivosDatosPersonales(String nombre,String apellido1, String apellido2){
		 ...
		 try {
			 ...
			 while (rset.next()){
				 if(rset.getString(1).equals(nombre) && rset.getString(2).equals(apellido1) && rset.getString(3).equals(apellido2))
			        ...
			        try
			        {
			            ...
			            //for (int i = 0; i < 10; i++)
			             //   pw.println("Linea " + i);
			            pw.println("Nombre del componente:\t"+rset.getString(1)+" "+rset.getString(2)+" "+rset.getString(3));
