			...
			//------------PULSAR BOTON-------------------------------------------------		
					...
					public void mousePressed(MouseEvent e) {
						...
						//--------------------PASAMOS DE STRING A FLOAT EL DINERO-------------	
										...
										}else{if(rdbtnPago_1.getSelectedObjects()!=null){
											InsertarPago insertarPago=new InsertarPago(nombre,apellido,superDinero,"segundo");

										}else{if(rdbtnPago_2.getSelectedObjects()!=null){
											InsertarPago insertarPago=new InsertarPago(nombre,apellido,superDinero,"tercero");

										}else{if(rdbtnPago_3.getSelectedObjects()!=null){
											InsertarPago insertarPago=new InsertarPago(nombre,apellido,superDinero,"cuarto");

										}else{if(rdbtnPago_4.getSelectedObjects()!=null){
											InsertarPago insertarPago=new InsertarPago(nombre,apellido,superDinero,"quinto");

										}else{if(rdbtnAdmision.getSelectedObjects()!=null){
											InsertarPago insertarPago=new InsertarPago(nombre,apellido,superDinero,"admisión");
			...
			groupLayout.createParallelGroup(Alignment.LEADING)
				.addGroup(groupLayout.createSequentialGroup()
					...
					.addGroup(groupLayout.createParallelGroup(Alignment.TRAILING)
						.addGroup(groupLayout.createSequentialGroup()
							.addComponent(lblcuantoVaA)
							.addGap(49)
							.addComponent(textField, GroupLayout.PREFERRED_SIZE, 73, GroupLayout.PREFERRED_SIZE)
							.addGap(46))
						.addGroup(groupLayout.createSequentialGroup()
							.addComponent(btnPagar, GroupLayout.PREFERRED_SIZE, 125, GroupLayout.PREFERRED_SIZE)
							.addGap(92)))
					.addGroup(groupLayout.createParallelGroup(Alignment.LEADING)
						.addComponent(rdbtnPago_3)
						.addComponent(rdbtnPago_2)
						.addComponent(rdbtnPago_1)
						.addComponent(rdbtnPago)
						.addComponent(rdbtnPago_4)
						.addComponent(rdbtnAdmision))
