...
public class CuotaDos extends JFrame{
	...
	public CuotaDos(){
		super("Componentes que faltan por pagar el segundo pago");		setSize(553, 434);
 ...
 ResultSet rset=stm.executeQuery("select NOMBREEMPLE, APELLIDOPRIMERO, SALDO, NUEVO, EDAD from COMPONENTE order by NOMBREEMPLE");
			 ...
			 while (rset.next()){
				 if(rset.getInt("SALDO")<40 && rset.getInt("EDAD")>11 || (rset.getInt("EDAD")<12 && rset.getString("NUEVO").equals("No") && rset.getInt("SALDO")<50)){
