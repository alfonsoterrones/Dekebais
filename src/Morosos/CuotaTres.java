...
public class CuotaTres extends JFrame{
	...
	public CuotaTres(){
		super("Componentes que faltan por pagar el tercer pago");		setSize(434, 519);
		...
		cursos.addMouseListener(new MouseAdapter() {
		 ...
		 try {
			 ...
			 while (rset.next()){
				 if(rset.getInt("SALDO")<60 && rset.getInt("EDAD")>11 || (rset.getInt("EDAD")<12 && rset.getString("NUEVO").equals("No") && rset.getInt("SALDO")<50)){
