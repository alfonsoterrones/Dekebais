...
import ExcelListado.ExcelMorososPrimerPago;
...
public class CuotaUno extends JFrame{
	...
	public CuotaUno(){
		super("Componentes que faltan por pagar el primer pago");	
		setSize(611, 417);
		setDefaultCloseOperation(JFrame.HIDE_ON_CLOSE);
		setVisible(true);
		setLocation(600,400);
		contentPane = new Fondo("morosos1.jpg");
		...
		cursos.addMouseListener(new MouseAdapter() {
		 ...
		 try {
			 ...
			 while (rset.next()){
				 if(rset.getInt("SALDO")<20 && rset.getInt("EDAD")>11 || (rset.getInt("EDAD")<12 && rset.getString("NUEVO").equals("No") && rset.getInt("SALDO")<50)){
			 ...
			 btnImprimir.addMouseListener(new MouseAdapter() {
			 	@Override
			 	public void mousePressed(MouseEvent e) {
			 		ExcelMorososPrimerPago pr = new ExcelMorososPrimerPago();
			 	}
			 });
