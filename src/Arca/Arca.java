...
public class Arca extends JFrame {
	...
	public Arca() {
		...
		gl_contentPane.setHorizontalGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_contentPane.createSequentialGroup().addGap(166)
						.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING).addComponent(lblSaldoActual)
								.addComponent(lblSaldoFinal).addComponent(lblFaltaPorPagar))
						.addContainerGap(216, Short.MAX_VALUE)));
		gl_contentPane.setVerticalGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_contentPane.createSequentialGroup().addContainerGap().addComponent(lblSaldoActual)
						.addPreferredGap(ComponentPlacement.RELATED).addComponent(lblSaldoFinal)
						.addPreferredGap(ComponentPlacement.RELATED).addComponent(lblFaltaPorPagar)
