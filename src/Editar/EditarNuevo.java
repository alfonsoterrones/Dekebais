					...
					while (rset.next()) {
						if ((rset.getString("NOMBREEMPLE") + " " + rset.getString("APELLIDOPRIMERO"))
							...
							if (si.getSelectedObjects() != null) {
								consulta = "UPDATE COMPONENTE SET NUEVO='Si' WHERE NOMBREEMPLE='"
								...
								if (no.getSelectedObjects() != null) {
									consulta = "UPDATE COMPONENTE SET NUEVO='No' WHERE NOMBREEMPLE='"
											+ rset.getString("NOMBREEMPLE") + "' AND APELLIDOPRIMERO='"
											+ rset.getString("APELLIDOPRIMERO") + "' AND APELLIDOSEGUNDO='"
											+ rset.getString("APELLIDOSEGUNDO") + "'";
									stm.executeUpdate(consulta);
									...
									JOptionPane.showMessageDialog(null,
											"Si todos son nuevos todos pagaran 10 euritos mas piensalo...", "Aviso", 1);
				...
				.addGroup(gl_contentPane.createSequentialGroup()
						.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
								...
								.addGroup(gl_contentPane.createSequentialGroup().addGap(109).addGroup(gl_contentPane
										...
										.addGroup(gl_contentPane.createSequentialGroup().addComponent(si)
												.addPreferredGap(ComponentPlacement.UNRELATED).addComponent(no)))))
						.addContainerGap(40, Short.MAX_VALUE)));
		gl_contentPane.setVerticalGroup(gl_contentPane.createParallelGroup(Alignment.LEADING).addGroup(gl_contentPane
				.createSequentialGroup().addContainerGap().addComponent(lblestaEsteAo)
				.addPreferredGap(ComponentPlacement.RELATED)
				.addGroup(gl_contentPane.createParallelGroup(Alignment.BASELINE).addComponent(si).addComponent(no))
