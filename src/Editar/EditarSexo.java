...
public class EditarSexo extends JFrame {
	...
	public EditarSexo(String componente) {
					...
					while (rset.next()) {
						if ((rset.getString("NOMBREEMPLE") + " " + rset.getString("APELLIDOPRIMERO"))
							...
							if (mujer.getSelectedObjects() != null) {
								consulta = "UPDATE COMPONENTE SET SEXO='Mujer' WHERE NOMBREEMPLE='"
								...
								if (hombre.getSelectedObjects() != null) {
									consulta = "UPDATE COMPONENTE SET SEXO='Hombre' WHERE NOMBREEMPLE='"
											+ rset.getString("NOMBREEMPLE") + "' AND APELLIDOPRIMERO='"
											+ rset.getString("APELLIDOPRIMERO") + "' AND APELLIDOSEGUNDO='"
											+ rset.getString("APELLIDOSEGUNDO") + "'";
									stm.executeUpdate(consulta);
		...
		gl_contentPane.setHorizontalGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_contentPane.createSequentialGroup().addGap(109).addComponent(btnAceptar)
						.addContainerGap(100, Short.MAX_VALUE))
				.addGroup(Alignment.TRAILING,
						gl_contentPane.createSequentialGroup().addContainerGap(77, Short.MAX_VALUE).addComponent(mujer)
								.addGap(18).addComponent(hombre).addGap(118))
				.addGroup(gl_contentPane.createSequentialGroup().addGap(108).addComponent(lblestaEsteAo)
						.addContainerGap(161, Short.MAX_VALUE))
				.addGroup(gl_contentPane.createSequentialGroup().addContainerGap().addComponent(lblSiemprePuedeSuceder)
						.addContainerGap(46, Short.MAX_VALUE)));
		gl_contentPane.setVerticalGroup(gl_contentPane.createParallelGroup(Alignment.LEADING).addGroup(gl_contentPane
				.createSequentialGroup().addContainerGap().addComponent(lblSiemprePuedeSuceder).addGap(21)
				.addComponent(lblestaEsteAo).addPreferredGap(ComponentPlacement.RELATED)
				.addGroup(
						gl_contentPane.createParallelGroup(Alignment.BASELINE).addComponent(mujer).addComponent(hombre))
