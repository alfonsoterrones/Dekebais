...
public class EditarNombre extends JFrame {

	private JPanel contentPane;
	private JTextField textField;

	String consulta;
	public EditarNombre(String componente) {
		super("Editar el nombre de "+componente);
		...
		JLabel lblCambiarElNombre = new JLabel("Cambiar el nombre de "+componente);
				...
				try {
					 ...
					 while (rset.next()){
							if( (rset.getString ("NOMBREEMPLE")+" "+rset.getString ("APELLIDOPRIMERO")).equals(componente)){
									consulta="UPDATE COMPONENTE SET NOMBREEMPLE='"+textField.getText()+"' WHERE NOMBREEMPLE='"+rset.getString("NOMBREEMPLE")+"' AND APELLIDOPRIMERO='"+rset.getString("APELLIDOPRIMERO")+"' AND APELLIDOSEGUNDO='"+rset.getString("APELLIDOSEGUNDO")+"'";
