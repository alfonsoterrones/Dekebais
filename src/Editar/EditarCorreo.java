...
public class EditarCorreo extends JFrame {

	private JPanel contentPane;
	private JTextField textField;

	String consulta;
	public EditarCorreo(String componente) {
		super("Editar el correo de "+componente);
		...
		JLabel lblCambiarElNombre = new JLabel("Cambiar el correo de "+componente);
				...
				try {
					 ...
					 while (rset.next()){
							if( (rset.getString ("NOMBREEMPLE")+" "+rset.getString ("APELLIDOPRIMERO")).equals(componente)){
									consulta="UPDATE COMPONENTE SET MAIL='"+textField.getText()+"' WHERE NOMBREEMPLE='"+rset.getString("NOMBREEMPLE")+"' AND APELLIDOPRIMERO='"+rset.getString("APELLIDOPRIMERO")+"' AND APELLIDOSEGUNDO='"+rset.getString("APELLIDOSEGUNDO")+"'";
					                stm.executeUpdate(consulta);
					                setVisible(false);
					                JOptionPane.showMessageDialog(null, "Hemos enviado el número 622845490 a todos\n los correos de la comparsa para que te puedan llamar\n a todas horas para que resulevan sus dudas\n asi tendremos mayor fluidez con las dudas de nuestros componentes xD", "Aviso",1);
