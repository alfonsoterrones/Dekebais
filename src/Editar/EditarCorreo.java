				...
				try {
					...
					while (rset.next()) {
						if ((rset.getString("NOMBREEMPLE") + " " + rset.getString("APELLIDOPRIMERO"))
								.equals(componente)) {
							consulta = "UPDATE COMPONENTE SET MAIL='" + textField.getText() + "' WHERE NOMBREEMPLE='"
							...
							JOptionPane.showMessageDialog(null,
									"Hemos enviado el número 622845490 a todos\n los correos de la comparsa para que te puedan llamar\n a todas horas para que resulevan sus dudas\n asi tendremos mayor fluidez con las dudas de nuestros componentes xD",
									"Aviso", 1);
