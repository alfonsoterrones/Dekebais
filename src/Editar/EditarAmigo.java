...
public class EditarAmigo extends JFrame {

	private JPanel contentPane;
	private JTextField textField;

	String consulta;
	public EditarAmigo(String componente) {
		super("Editar el amigo de "+componente);
		...
		JLabel lblCambiarElNombre = new JLabel("Cambiar el amigo de "+componente);
				...
				try {
					 ...
					 while (rset.next()){
							if( (rset.getString ("NOMBREEMPLE")+" "+rset.getString ("APELLIDOPRIMERO")).equals(componente)){
									consulta="UPDATE COMPONENTE SET AMIGO='"+textField.getText()+"' WHERE NOMBREEMPLE='"+rset.getString("NOMBREEMPLE")+"' AND APELLIDOPRIMERO='"+rset.getString("APELLIDOPRIMERO")+"' AND APELLIDOSEGUNDO='"+rset.getString("APELLIDOSEGUNDO")+"'";
