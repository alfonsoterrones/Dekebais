	...
	public EditarCuerpo(String componente) {
					...
					while (rset.next()) {
						if ((rset.getString("NOMBREEMPLE") + " " + rset.getString("APELLIDOPRIMERO"))
							...
							if (baila.getSelectedObjects() != null) {
								consulta = "UPDATE COMPONENTE SET CUERPO='Baile' WHERE NOMBREEMPLE='"
								...
								JOptionPane.showMessageDialog(null,
										"Se no tiene ni idea de bailar se queda en el baile!!! jaja", "Aviso", 1);
							} else {
								if (toca.getSelectedObjects() != null) {
									consulta = "UPDATE COMPONENTE SET CUERPO='Musica' WHERE NOMBREEMPLE='"
											+ rset.getString("NOMBREEMPLE") + "' AND APELLIDOPRIMERO='"
											+ rset.getString("APELLIDOPRIMERO") + "' AND APELLIDOSEGUNDO='"
											+ rset.getString("APELLIDOSEGUNDO") + "'";
									stm.executeUpdate(consulta);
									setVisible(false);
									JOptionPane.showMessageDialog(null,
											"Se consultara si toca bien sino va automaticamente al baile!!!", "Aviso",
											1);
								}
		...
		gl_contentPane.setHorizontalGroup(gl_contentPane.createParallelGroup(Alignment.LEADING).addGroup(gl_contentPane
				...
				.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
						.addGroup(gl_contentPane.createSequentialGroup().addGap(109).addComponent(baila)
								.addPreferredGap(ComponentPlacement.UNRELATED).addComponent(toca))
						.addGroup(gl_contentPane.createSequentialGroup().addGap(119).addComponent(btnAceptar))
						.addGroup(gl_contentPane.createSequentialGroup().addGap(124).addComponent(lblestaEsteAo))
						.addGroup(gl_contentPane.createSequentialGroup().addContainerGap().addComponent(label)))
				.addContainerGap(122, Short.MAX_VALUE)));
		gl_contentPane.setVerticalGroup(gl_contentPane.createParallelGroup(Alignment.LEADING).addGroup(gl_contentPane
				.createSequentialGroup().addContainerGap().addComponent(lblestaEsteAo)
				.addPreferredGap(ComponentPlacement.RELATED)
				.addGroup(gl_contentPane.createParallelGroup(Alignment.BASELINE).addComponent(baila).addComponent(toca))
