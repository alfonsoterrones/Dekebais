		...
		gl_contentPane.setHorizontalGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_contentPane.createSequentialGroup().addGap(22)
						.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
								.addGroup(gl_contentPane.createSequentialGroup().addComponent(btnComponente)
										.addPreferredGap(ComponentPlacement.RELATED).addComponent(btnFechaDeNacimiento))
								.addGroup(gl_contentPane.createSequentialGroup().addComponent(btnSexo)
										.addPreferredGap(ComponentPlacement.RELATED).addComponent(btnAmigo)
										.addPreferredGap(ComponentPlacement.RELATED).addComponent(btnSaldo)
										.addPreferredGap(ComponentPlacement.RELATED).addComponent(btnModista))
								.addGroup(gl_contentPane.createSequentialGroup().addComponent(btnCuerpo)
										.addPreferredGap(ComponentPlacement.RELATED).addComponent(btnCorreo_1)
										.addPreferredGap(ComponentPlacement.UNRELATED).addComponent(btnTelefono)
										.addPreferredGap(ComponentPlacement.UNRELATED).addComponent(btnNuevo))
								.addGroup(gl_contentPane.createSequentialGroup().addComponent(btnNombre)
										.addPreferredGap(ComponentPlacement.UNRELATED).addComponent(btnPrimerApellido)
										.addPreferredGap(ComponentPlacement.UNRELATED)
										.addComponent(btnSegundoApellido)))
						.addContainerGap(49, Short.MAX_VALUE)));
		gl_contentPane.setVerticalGroup(gl_contentPane.createParallelGroup(Alignment.LEADING).addGroup(gl_contentPane
				.createSequentialGroup().addContainerGap()
				.addGroup(gl_contentPane.createParallelGroup(Alignment.BASELINE).addComponent(btnNombre)
						.addComponent(btnPrimerApellido).addComponent(btnSegundoApellido))
				.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
						.addGroup(gl_contentPane.createSequentialGroup().addPreferredGap(ComponentPlacement.RELATED)
								.addGroup(gl_contentPane.createParallelGroup(Alignment.BASELINE).addComponent(btnCuerpo)
						...
						.addGroup(Alignment.TRAILING,
								gl_contentPane.createSequentialGroup()
										...
										.addGroup(gl_contentPane.createParallelGroup(Alignment.BASELINE)
												.addComponent(btnTelefono).addComponent(btnNuevo))
										.addPreferredGap(ComponentPlacement.RELATED)))
				.addGroup(gl_contentPane.createParallelGroup(Alignment.BASELINE).addComponent(btnSexo)
						.addComponent(btnAmigo).addComponent(btnSaldo).addComponent(btnModista))
				.addPreferredGap(ComponentPlacement.RELATED)
				.addGroup(gl_contentPane.createParallelGroup(Alignment.BASELINE).addComponent(btnComponente)
