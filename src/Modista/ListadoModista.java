...
public class ListadoModista extends JFrame {
	...
	public ListadoModista() {
		...
		try {
			...
			ResultSet rset = stm
					.executeQuery("select NOMBREEMPLE,APELLIDOPRIMERO,MODISTA from COMPONENTE order by NOMBREEMPLE");
			...
			gl_contentPane.setHorizontalGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
					.addGroup(gl_contentPane.createSequentialGroup().addGroup(gl_contentPane
							...
							.addGroup(gl_contentPane.createSequentialGroup().addGap(162).addComponent(lblLaModistaDe)))
			...
			gl_contentPane.setVerticalGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
					.addGroup(gl_contentPane.createSequentialGroup().addContainerGap()
							...
							.addComponent(lblLaModistaDe).addGap(49)));
