	...
	public Lista() {
		...
		try {
			...
			btnImprimir.addMouseListener(new MouseAdapter() {
				@Override
				public void mousePressed(MouseEvent e) {
					ExcelListado2 x = new ExcelListado2();
				}
			});
			GroupLayout gl_contentPane = new GroupLayout(contentPane);
			gl_contentPane.setHorizontalGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
					.addGroup(gl_contentPane.createSequentialGroup().addContainerGap().addComponent(lblTotalComponentes)
							.addGap(52).addComponent(lblMediaDeEdad)
							.addPreferredGap(ComponentPlacement.RELATED, 81, Short.MAX_VALUE).addComponent(btnImprimir)
							.addGap(67))
					.addGroup(gl_contentPane
							.createSequentialGroup().addGap(201).addComponent(cursos, GroupLayout.PREFERRED_SIZE,
							...
							.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
									.addGroup(gl_contentPane.createSequentialGroup()
											...
											.addGroup(gl_contentPane.createParallelGroup(Alignment.BASELINE)
													.addComponent(lblTotalComponentes).addComponent(lblMediaDeEdad)))
