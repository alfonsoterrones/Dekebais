...
import ExcelListado.ExcelListarEsteAno;
...
public class ListarEsteAno extends JFrame{
	...
	public ListarEsteAno(){
		super("Componentes 2017");
		setSize(568, 513);
		 ...
		 try {
			 ...
			 btnImprimir.addActionListener(new ActionListener() {
				 ...
				 public void actionPerformed(ActionEvent e) {
			 		ExcelListarEsteAno es=new ExcelListarEsteAno();
			 	}
			 });
