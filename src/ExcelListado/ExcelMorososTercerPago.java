 ...
 * @author Beto Rojas
 */
public class ExcelMorososTercerPago {

	public ExcelMorososTercerPago() {
		...
		try {
			...
			FileOutputStream archivo = new FileOutputStream("MosososTercerPago.xls");
			libro.write(archivo);
			archivo.close();
