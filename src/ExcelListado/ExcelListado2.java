 ...
 * @author Beto Rojas
 */
public class ExcelListado2 {

	public ExcelListado2() {
		...
		try {
			...
			ResultSet rset = stm.executeQuery(
					"select NOMBREEMPLE, APELLIDOPRIMERO, APELLIDOSEGUNDO, MAIL, FECHNACIMIENTO, SALDO, AMIGO, TELEFONO, CUERPO, NUEVO, EDAD ,MODISTA from COMPONENTE");
