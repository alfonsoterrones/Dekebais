 ...
 * @author Beto Rojas
 */
public class ExcelMorososSegundoPago {

	public ExcelMorososSegundoPago() {
		...
		try {
			...
			FileOutputStream archivo = new FileOutputStream("MosososSegundoPago.xls");
			libro.write(archivo);
			archivo.close();
